...
class MenuTienda:
    ...
    def mostrar_estadisticas(self):
        ...
        table.add_row("Total muebles vendidos (acumulado)", str(stats.get("total_muebles_vendidos", 0)))
        table.add_row("Valor total de ventas (acumulado)", f"${stats.get('valor_total_ventas', 0):.2f}")
        self.console.print(table)
